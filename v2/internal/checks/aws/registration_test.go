...
func TestAllChecksUnique(t *testing.T) {
	...
	// + SG transitive world-open(1) + SG peer-reachable exposure(1)
	// + TGW lateral exposure(1) = 54.
	...
	// Plus the policy-as-code rules umbrella check = 1. Total = 113.
	const wantChecks = 113
