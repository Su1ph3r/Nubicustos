...
### Multi-Cloud Support
- **AWS**: Prowler, ScoutSuite, CloudFox, CloudSploit, Cloud Custodian, CloudMapper, Cartography
...
- Report processing after successful scans
...
|------|---------|-------------|
| 8080 | Nginx | Web interface for reports |
| 8000 | FastAPI | REST API |
| 3000 | Grafana | Security dashboards |
