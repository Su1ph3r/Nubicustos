...
class TestCSVExport:
    ...
    def test_export_csv_filter_by_severity(
        self, client: TestClient, sample_findings
    ) -> None:
    ...
    def test_export_csv_include_remediation(
        self, client: TestClient, sample_findings
    ) -> None:
    ...
    def test_export_csv_exclude_remediation(
        self, client: TestClient, sample_findings
    ) -> None:
...
class TestJSONExport:
    ...
    def test_export_json_filter_by_severity(
        self, client: TestClient, sample_findings
    ) -> None:
        ...
        assert all(
            f["severity"] == "high" for f in data["findings"]
        )
    ...
    def test_export_json_finding_structure(
        self, client: TestClient, sample_finding
    ) -> None:
        ...
        if data["findings"]:
            ...
            required_fields = [
                "finding_id", "tool", "severity", "status",
...
class TestGenerateExport:
    ...
    def test_generate_export_csv_format(
        self, client: TestClient, sample_findings
    ) -> None:
    ...
    def test_generate_export_json_format(
        self, client: TestClient, sample_findings
    ) -> None:
    ...
    def test_generate_export_with_status_filter(
        self, client: TestClient, sample_findings
    ) -> None:
        """Test generating export with status filter."""
        response = client.post(
            "/api/exports/generate",
            json={"status_filter": ["open"]}
        )
...
class TestExportSummary:
    ...
    def test_export_summary_with_data(
        self, client: TestClient, sample_findings
    ) -> None:
